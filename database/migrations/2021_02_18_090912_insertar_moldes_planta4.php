...
class InsertarMoldesPlanta4 extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        DB::unprepared('DROP procedure if exists `insertar_moldes_planta4`');
        ...
        BEGIN
           DECLARE suma_estado INT;
                        ...
                        INSERT INTO moldes(moldes.id_planta, moldes.id_vitola, moldes.id_figura,
                         ...
                         VALUES("4", pa_id_vitola,pa_id_figura, pa_bueno, pa_irregular, pa_malo, pa_bodega, pa_reparacion, pa_salon, suma_estado);
