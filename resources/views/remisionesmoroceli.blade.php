        ...
        <div class="container-fluid">
            <div class="collapse navbar-collapse" id="navbarNav">
                ...
                <ul class="navbar-nav nav ">
                    ...
                    <li class="nav-item">
                        <a style="background:#b39f64;" class="nav-link download" data-toggle="modal"
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="mb-3 col">
                                        ...
                                        <input class="form-control" type="number" id="txt_cantidad" name="txt_cantidad"
                                            placeholder="Ingresa la cantidad" minLength="1" maxLength="10" required>
                                    </div>
