...
<div class="col form-inline">
  ...
  <form action=  "{{Route('buscar_remision_moroceli',2)}}" method= "POST" class="form-inline"  name= "formulario_enviadas" id= "formulario_enviadas">
      @csrf
  ...
  <form action=  "{{Route('imprimirdatosparaiso',2)}}" method= "POST" class=" form-inline">
...
<form id = "formulario_mostrar" name = "formulario_mostrar"
 action = "{{Route('actualizarremision_moroceli',2)}}"  
 method="POST">
...
<form action=  "{{Route('insertarremisiones_moroceli',2)}}" method= "POST" id ="FormRemisiones" name="FormRemisiones">
@csrf
