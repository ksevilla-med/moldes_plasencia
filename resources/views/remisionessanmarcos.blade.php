...
<div class="col form-inline">
  ...
  <form action=  "{{Route('buscar_remision_sanMarcos',3)}}" method= "POST" class="form-inline"  name= "formulario_enviadas" id= "formulario_enviadas">
      @csrf
  ...
  <form action=  "{{Route('imprimirdatosparaiso',3)}}" method= "POST" class=" form-inline">
...
<form id = "formulario_mostrar" name = "formulario_mostrar"
 action = "{{Route('actualizarremision_sanMarcos',3)}}"  
 method="POST">
